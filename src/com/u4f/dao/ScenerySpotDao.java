...
//	ScenerySpotDao dao=new ScenerySpotDao ();
	...
	public List<ScenerySpot> getAllScenerySpot(){
		ScenerySpotDao dao=new ScenerySpotDao ();
		 String sql="select * from ScenerySpot where ScenerySpotLat>34.2566";//and ScenerySpotLat<34.256700002761306
	...
	public List<ScenerySpot> getNearScenerySpot(Double latitude,Double longtitude){
		...
		Map<String,String> map=new HashMap<String,String>();
		 ...
		 double minLat=MapDistance.take_effect_number(Double.parseDouble(map.get("minLat")));
		 double maxLat=MapDistance.take_effect_number(Double.parseDouble(map.get("maxLat")));
		 double minLong=MapDistance.take_effect_number(Double.parseDouble(map.get("minLng")));
		 double maxLong=MapDistance.take_effect_number(Double.parseDouble(map.get("maxLng")));
		 
		
		 System.out.println("minlat:"+minLat+",maxLat:"+maxLat+",minLong:"+minLong+",maxLng:"+maxLong);
		 
		
			conn = DBTools.getConn(conn);
			//String sql="select * from ScenerySpot where ScenerySpotLat between ? and ? and ScenerySpotLong between ? and ? ";
			String sql="select * from ScenerySpot where ScenerySpotLat between "+minLat+" and "+maxLat +" and ScenerySpotLong between "+minLong+" and "+maxLong ;
