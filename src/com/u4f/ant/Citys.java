...
//	private int[][] distance = new int[34][34];
	...
	/**
		distance[0][0] = distance[1][1] = distance[2][2] = distance[3][3] = distance[4][4] = distance[5][5] = 0;
		distance[0][1] = distance[1][0] = 108;
		distance[0][2] = distance[2][0] = 264;
		distance[0][3] = distance[3][0] = 404;
		distance[0][4] = distance[4][0] = 907;
		distance[0][5] = distance[5][0] = 413;
		
		distance[1][2] = distance[2][1] = 263;
		distance[1][3] = distance[3][1] = 427;
		distance[1][4] = distance[4][1] = 902;
		distance[1][5] = distance[5][1] = 506;
		
		distance[2][3] = distance[3][2] = 176;
		distance[2][4] = distance[4][2] = 644;
		distance[2][5] = distance[5][2] = 392;
		
		distance[3][4] = distance[4][3] = 507;
		distance[3][5] = distance[5][3] = 338;
		
		distance[4][5] = distance[5][4] = 764;
		printSimMaxtri(cityName,distance);
	}
	//private int[][] distance = new int[34][34];
